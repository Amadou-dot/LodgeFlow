...
export function CallToActionSection({ 
  ...
  const backgroundClasses = {
    default: 'bg-content1',
    gradient: 'bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-950 dark:to-blue-950',
    colored: 'bg-green-50 dark:bg-green-950',
  };

  return (
    <section className={`text-center ${backgroundClasses[background]} rounded-2xl p-12 ${className}`}>
